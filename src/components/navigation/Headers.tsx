...
export default function Header() {
  ...
  return (
    <header className="sticky top-0  w-full h-[100px] bg-black px-10 py-2 md:py-3 flex items-center justify-between bg-black/60 backdrop-blur-xl border-b border-white/10 text-[#FFF4E6] transition-all duration-300">
